...
<aside class="app-sidebar ">
    <div class="sidebar-img">
        <a class="navbar-brand" href="https://welcome.twhive.com">
            <img alt="..." class="navbar-brand-img main-logo" src="/assets/img/brand/main-logo.png">
            <img alt="..." class="navbar-brand-img logo" src="/assets/img/brand/logo.png">
        </a>
        <ul class="side-menu">
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li>
                        <a class="slide-item" href="/index">User Dashboard</a>
                    </li>
                    <li>
                        <a class="slide-item" href="/index">Invites</a>
                    </li>
                    @if($userType === 'brand')
                    <li>
                        <a class="slide-item" href="/search">Search</a>
                    </li>
                    @elseif($userType === 'influencer')
                    {{-- <li>
                        <a class="slide-item" href="/index">Search</a>
                    </li> --}}
                    @endif
                    {{-- <li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li>
                        <a href="/profile" class="slide-item">Profile</a>
                    </li>
                    {{-- <li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon fe fe-shopping-cart"></i><span class="side-menu__label">Account</span><i class="angle fa fa-angle-right"></i></a>
                <ul class="slide-menu">
                    <li>
                        <a href="shop.html" class="slide-item">Products</a>
                    </li>
